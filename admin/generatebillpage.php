...
<h1 class="bg-primary text-center font-weight-bold" style="font-size:30px;">Generate Bill And View Bill</h1>
</div>
...
<a href="generatebill.php" id="add">Generate Bill</a>
<a href="viewbill.php" id="update">View Bill</a><br>
