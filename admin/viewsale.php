...
<h1 class="bg-primary text-center font-weight-bold" style="font-size:30px;">Add product And View Sale</h1>
</div>
...
<a href="addinsalepro.php" id="add">Add product in Sale</a>
<a href="viewsalepage.php" id="update">View Sale</a><br>
