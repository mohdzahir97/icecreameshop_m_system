...
<h1 class="bg-primary text-center font-weight-bold" style="font-size:30px;">Delete Product</h1>
</div>
...
<table align="center" width="80%" border="1" style="margin-top:10px">
	<tr>
	<td colspan="7"><center><h3>Delete Product Detail:</h3></center></td>
	</tr>
	<tr>
	<th>No:-</th>
	<th>product_id</th>
	...
	else
	{
		...
		while($data=mysqli_fetch_assoc($run))
		{
			...
			<tr align="center">
				...
				<td><?php echo $data['p_name'];?>
				<td><?php echo $data['p_id'];?></td></td>
				<td><?php echo $data['p_unit'];?></td>
				<td><?php echo $data['p_amount'];?></td>
				<td><?php echo $data['remaining_quantity'];?></td>
				<td><a href="deleteproductform.php?sid=<?php echo $data['p_id'];?>">Delete</a></th>
			</tr>
