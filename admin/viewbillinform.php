...
<form action="viewbillinform.php" method="post">
<div>
...
<tr>
<td colspan="5">Bill NO:<?php echo $data['cust_id'];?><center><h4> <b>Mahaveer Ice Cream Parlour</b></h4></center></td>
</tr>
<tr>
...
<center><p><button id="btn1" class="btn btn-success">print</button><a href="viewbill.php">cancel</a></p></center>
</div>
